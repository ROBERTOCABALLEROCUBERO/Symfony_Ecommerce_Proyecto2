 ...
 */
final class Version20230120170955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, fechanac DATE NOT NULL, numtarjeta VARCHAR(255) NOT NULL, titular VARCHAR(255) NOT NULL, cod_seg VARCHAR(3) NOT NULL, direccion VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D6493A909126 (nombre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
